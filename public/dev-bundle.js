System.register("js/materialize-css/Navbar.js", ["npm:react@0.14.3"], function (_export) {
    "use strict";
...
System.register("js/materialize-css/CardAction.js", ["npm:react@0.14.3"], function (_export) {
    "use strict";

    var React, CardAction;
    return {
        setters: [function (_npmReact0143) {
            React = _npmReact0143["default"];
        }],
        execute: function () {
            ...
            _export("default", CardAction);
        }
    };
});
System.register("js/materialize-css/CardContent.js", ["npm:react@0.14.3"], function (_export) {
    "use strict";

    var React, CardContent;
    return {
        setters: [function (_npmReact0143) {
            React = _npmReact0143["default"];
        }],
        execute: function () {
            CardContent = React.createClass({
            ...
            _export("default", CardContent);
        }
    };
});
System.register("js/materialize-css/CardImage.js", ["npm:react@0.14.3"], function (_export) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            _export("default", CardImage);
        }
    };
});
System.register("js/materialize-css/Card.js", ["npm:react@0.14.3"], function (_export) {
    "use strict";
...
System.registerDynamic("npm:babel-runtime@5.8.34/helpers/extends", ["npm:babel-runtime@5.8.34/core-js/object/assign"], true, function($__require, exports, module) {
  "use strict";
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var _Object$assign = $__require('npm:babel-runtime@5.8.34/core-js/object/assign')["default"];
...
System.register('js/materialize-css/CollectionItem.js', ['npm:babel-runtime@5.8.34/helpers/extends', 'npm:react@0.14.3'], function (_export) {
    var _extends, React, CollectionItem;
        ...
        execute: function () {
            ...
            CollectionItem = React.createClass({
                ...
                render: function render() {
                    return React.createElement(
                        'li',
                        _extends({ className: ['collection-item', this.props.active ? 'active' : ''].join(' ') }, this.props),
                        this.props.children
                    );
                }
            });

            _export('default', CollectionItem);
        }
    };
});
System.register("js/materialize-css/Collections.js", ["npm:react@0.14.3"], function (_export) {
    /**
     * Created by morton on 26/11/15.
     */
    "use strict";

    var React, Collections;
    return {
        setters: [function (_npmReact0143) {
            React = _npmReact0143["default"];
        }],
        execute: function () {
            ...
            _export("default", Collections);
        }
    };
});
System.register('js/pixel_dailies.js', ['npm:react@0.14.3', 'js/materialize-css/Collections.js', 'js/materialize-css/CollectionItem.js', 'js/materialize-css/Card.js', 'js/materialize-css/CardImage.js', 'js/materialize-css/CardContent.js', 'js/materialize-css/CardAction.js', 'js/materialize-css/Navbar.js'], function (_export) {
    'use strict';

    var React, Collections, CollectionItem, Card, CardImage, CardContent, CardAction, Navbar, Pixel_dailies;
    return {
        setters: [function (_npmReact0143) {
            React = _npmReact0143['default'];
        }, function (_jsMaterializeCssCollectionsJs) {
            Collections = _jsMaterializeCssCollectionsJs['default'];
        }, function (_jsMaterializeCssCollectionItemJs) {
            CollectionItem = _jsMaterializeCssCollectionItemJs['default'];
        }, function (_jsMaterializeCssCardJs) {
            Card = _jsMaterializeCssCardJs['default'];
        }, function (_jsMaterializeCssCardImageJs) {
            CardImage = _jsMaterializeCssCardImageJs['default'];
        }, function (_jsMaterializeCssCardContentJs) {
            CardContent = _jsMaterializeCssCardContentJs['default'];
        }, function (_jsMaterializeCssCardActionJs) {
            CardAction = _jsMaterializeCssCardActionJs['default'];
        }, function (_jsMaterializeCssNavbarJs) {
            Navbar = _jsMaterializeCssNavbarJs['default'];
        }],
        execute: function () {
            ...
            Pixel_dailies = React.createClass({
                displayName: 'Pixel_dailies',

                getInitialState: function getInitialState() {
                    "use strict";
                    return {
                        topics: ["Lich", "raccoon", "battletoads", "blight", "darkness"],
                        currentTopic: {
                            name: "Lich",
                ...
                render: function render() {
                    ...
                    return React.createElement(
                        'div',
                        null,
                        React.createElement(Navbar, { title: this.state.currentTopic }),
                        React.createElement(
                            'div',
                            { className: 'row' },
                            React.createElement(
                                'div',
                                { className: 'col s3 menu' },
                                React.createElement(
                                    Collections,
                                    null,
                                    this.state.topics.map(function (name) {
                                        return React.createElement(
                                            CollectionItem,
                                            { href: '#!', active: name == _this.state.curentTopic.name },
                                            name
                                        );
                                    }, this)
                                )
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            Card,
                                            null,
                                            React.createElement(CardImage, { src: 'http://pbs.twimg.com/media/CUMfAjeVEAAa7XE.png' }),
                                            React.createElement(
                                                CardContent,
                                                null,
                                                '99 problems but a #lich ain’t one @Pixel_Dailies #pixel_dailies #pixelart https://t.co/ha5pjfxsEg'
                                            ),
                                            React.createElement(
                                                CardAction,
                                                { href: 'http://www.twitter.com/DustinInTN',
                                                    target: '_blank' },
                                                '@DustinInTN'
                                            )
                                        )
...
System.register('js/main.js', ['npm:react@0.14.3', 'npm:react-dom@0.14.3', 'js/pixel_dailies.js'], function (_export) {
  'use strict';

  var React, ReactDOM, Pixel_dailies;
  return {
    setters: [function (_npmReact0143) {
      React = _npmReact0143['default'];
    }, function (_npmReactDom0143) {
      ReactDOM = _npmReactDom0143['default'];
    }, function (_jsPixel_dailiesJs) {
      Pixel_dailies = _jsPixel_dailiesJs['default'];
    }],
    execute: function () {

      ReactDOM.render(React.createElement(Pixel_dailies, null), document.getElementById('ReactContainer'));
    }
  };
});
